import 'package:pickme/models/loginuser.dart';
import 'package:pickme/services/auth.dart';
...
class _Register extends State<SignUpPage>{
  ...
  Widget build(BuildContext context) {
    ...
    final emailField = TextFormField(
        ...
        validator: (value) {
          if (value != null) {
            if (value.contains('@') && value.endsWith('eng.asu.edu.eg')) {
              return null;
            }

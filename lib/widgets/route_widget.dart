                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.end, children: [
                      // MaterialButton(
                      //   color: Constants.THEME_COLOR_1,
                      //   child: myText('Join', 20, FontWeight.bold, color: Colors.white),
                      //   onPressed: () {},
                      // ),
                      // ElevatedButton.icon(
                      ...
                      //   label: myText('Join', 20, FontWeight.bold, color: Colors.white),
                      // )
                      GestureDetector(
                        onTap: () {},
                        child: Container(
                          ...
                          child: Center(
                            child: myText('Join', 20, FontWeight.bold,
                                color: Colors.white),
                          ),
                        ),
                      )
